...
/**
 * Static, non-interactive recreation of the ChatGPT home screen.
 * Sits behind the SettingsModal purely as demo backdrop — no state, no handlers.
 */
...
export function ChatGptBackground() {
  return (
    <div className="fixed inset-0 flex bg-[#f9f9f9] text-gray-700 select-none overflow-hidden">
      {/* Sidebar rail */}
      <aside className="hidden sm:flex flex-col items-center w-[56px] py-4 gap-7 border-r border-gray-200/70">
        ...
        <div className="mt-auto h-8 w-8 rounded-full bg-gray-300" />
      </aside>
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        <header className="flex items-center justify-between px-4 py-3.5">
          <div className="flex items-center gap-2">
            <PanelLeft size={18} className="sm:hidden text-gray-500" />
